    ...
    <div className="total-supply">
      <div className="left-text">
        ...
        <span>
          ...
          protocol while earning a variable rate based on market demands of that
          asset. Rates are earned per Ethereum block mined
        </span>
      </div>
      <div className="table-total-supply">
        ...
        <div className="table-total-supply-footer">
          <div>
            ...
            <div className="footer-value">{`$${format(new BigNumber(supplyVolume).toFormat(2))}`}</div>
          </div>
          <div>
